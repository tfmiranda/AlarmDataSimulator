...
public class Main {
    ...
    public static void main(String[] args) {
        Map<Alarm, Map<Alarm, CausalRelation>> relations = getCenarioTeste1();   // Relations map
     ...
     * Generic industrial alarms scenario
      * @return
     */
    private static Map<Alarm, Map<Alarm, CausalRelation>> getCenarioTeste1() {
        ...
        Alarm C = new Alarm("C", (float) 0.00038, (long) 2 * 60, (long) 30);
        Alarm D = new Alarm("D", (float) 0.00000, (long) 2 * 60, (long) 60);
        Alarm E = new Alarm("E", (float) 0.00025, (long) 1 * 60, (long) 30);
        Alarm F = new Alarm("F", (float) 0.00020, (long) 2 * 60, (long) 30);
        ...
        mapC.put(D, new CausalRelation((float) 80, (long) 15 * 60, (long) 10));
        ...
        mapD.put(E, new CausalRelation((float) 0, (long) 0, (long) 0));
        ...
        mapE.put(F, new CausalRelation((float) 80, (long) 15 * 60, (long) 10));
